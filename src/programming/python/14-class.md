...
1. 让 AI 一句话总结游戏规则和玩法操作。
    ...
    ![](./14-class.assets/image-20251027144911466.png)

2. 在此基础上，把游戏原始代码的游戏过程，也就是上一步准备的“游戏实际对话记录”给 AI ，并告知我们的目的是提供给 AI 的。

    ![提问内容](./14-class.assets/image-20251027145124813.png)
...
![大模型成功返回了我们需要的结果 A](./14-class.assets/image-20251027152916927.png)
